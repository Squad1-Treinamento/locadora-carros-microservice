package com.cursopcv.apigateway.controller;
...
public class GatewayController {
    ...
    public Mono<ResponseEntity<String>> proxy(
        ...
        String baseUrl = switch (service) {
            case "motorista-service" -> "http://localhost:8081";
            case "aluguel-service" -> "http://localhost:8082";
            case "carro-service" -> "http://localhost:8083";
            default -> null;
        };
